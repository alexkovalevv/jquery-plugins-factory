(function($) {
	...
	socialButton.init = function(options, plugin) {
		...
		this.urlHash = $.aikaCore.tools.hash(this.url);
	...
	socialButton.getCache = function(all) {
		var counterCache = $.aikaCore.tools.getFromStorage(this.counterCacheName);
	...
	socialButton.setCache = function(number) {
		...
		$.aikaCore.tools.setStorage(self.counterCacheName, storageData, 1);
	...
	socialButton.createButton = function() {
		...
		return this.component._createSkin(buttonTemplate, themeVars);
	};
	...
	socialButton.makeUrl = function(url, context) {
		return this.component._createSkin(url, context, encodeURIComponent);
	};
	...
	$.aikaComponent.sbtns.control = socialButton;
