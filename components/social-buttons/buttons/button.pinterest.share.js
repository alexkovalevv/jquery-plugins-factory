...
(function($) {
	...
	button.getIcon = function() {
		return '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 100.001 100.001" style="enable-background:new 0 0 100.001 100.001;" xml:space="preserve" width="512px" height="512px">' +
	...
	$.aikaComponent.sbtns.buttons["pinterest-share"] = button;
